...
func run() error {
	...
	r.Route("/c/{slug}", func(r chi.Router) {
		...
		if cfg.ProjectsEnabled {
			...
			r.Get("/projects/{id}/issues", projectsHandler.GetIssuesTab)
			r.Post("/projects/{id}/issues", projectsHandler.PostCreateIssue)
			r.Get("/projects/{id}/issues/{iid}", projectsHandler.GetIssue)
			r.Post("/projects/{id}/issues/{iid}", projectsHandler.PostIssueEdit)
			r.Post("/projects/{id}/issues/{iid}/status", projectsHandler.PostIssueStatus)
			r.Post("/projects/{id}/issues/{iid}/delete", projectsHandler.PostIssueDelete)
			r.Post("/projects/{id}/issues/{iid}/comment", projectsHandler.PostIssueComment)
			r.Post("/projects/{id}/issues/{iid}/comment/{cid}", projectsHandler.PostIssueCommentEdit)
			r.Post("/projects/{id}/issues/{iid}/comment/{cid}/delete", projectsHandler.PostIssueCommentDelete)
			r.Post("/projects/{id}/issues/{iid}/attachment", projectsHandler.PostIssueAttachmentUpload)
			r.Post("/projects/{id}/issues/{iid}/attachment/{aid}/delete", projectsHandler.PostIssueAttachmentDelete)
