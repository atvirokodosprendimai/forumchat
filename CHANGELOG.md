...
- 2026-06-26 `b710355` fix(css): report-chip danger tint was a dead rule (.wh-chip won on source order)
- 2026-06-28 `b0a34e6` fix(uploads): block stored XSS via html/svg uploads (C2,C3,H1,H2,L5)
- 2026-06-28 `b63ac45` fix(config): reject insecure prod defaults + fail-closed SMTP/auto-verify (C6,C7,M22,M23)
- 2026-06-28 `5f15817` fix(http): security headers + dev-only debug routes + prod TLS/cookie guards (H16,H17,H18)
- 2026-06-28 `eb1c1ea` fix(rooms): tenant-check + rate-limit PostChat (C1,H8)
- 2026-06-28 `fd4239d` fix(agent): re-validate read access in ResolveRef $-refs (C4,H14)
- 2026-06-28 `8d55374` fix(agent): rate-limit pane send/new/regenerate + /summary (C5,H15)
- 2026-06-28 `3e5414c` fix: rate-limit all human send paths + dedup chat reports (H6,H7,H9,H10,M25,M27,N7)
- 2026-06-28 `374fc2a` fix(rooms): marshal user-derived SSE signal with json.Marshal (H11)
- 2026-06-28 `44cc8ba` fix(rag,mcp): keep restricted-project content out of community index/tools (H12,H13)
- 2026-06-28 `d3853cc` fix: atomic membership removal + invite consume (M1,M2,M3)
- 2026-06-28 `a8148c5` fix(auth): rotate session token on password change (M4)
- 2026-06-28 `7167b56` fix(todos): scope chat/forum snapshot source to viewer community (M10)
- 2026-06-28 `c16687f` fix(natsx): sanitize ids in NATS subject builders (M15)
- 2026-06-28 `105f34e` fix(agent): meter estimated input tokens on errored turn (M13)
- 2026-06-28 `f69b552` fix(dataexport): traversal guard + one-active-export race (M21,N6)
- 2026-06-28 `93bb1fb` fix(uploads): fail closed on nil MemberOf in GetFile (M28)
- 2026-06-28 `14716ff` fix(auth): guard PostPassword session rotation on nil Sessions (M4 followup)
- 2026-06-28 `471224d` fix(auth): block OAuth account creation when age gate is on (N1)
- 2026-06-28 `5b33f87` fix: low-severity hardening L1,L2,L3,L4,L6
- 2026-06-28 `c146904` fix(projects): guest write access, close-all role, guest SSE access (M11,M12,M14)
- 2026-06-28 `80a3bd0` fix(connectors): membership guard on all signed actions + moderate posts (N2,N5)
- 2026-06-28 `9ec7321` fix(moderation): fence classifier input + de-weaponize risk floor (N3,N4)
- 2026-06-28 `4aa430f` fix(blocks): two-way block enforcement (M6,M7)
- 2026-06-28 `6515ba1` fix: encrypt webhook + connector HMAC secrets at rest (M19,M20)
- 2026-06-28 `da9b896` fix(webhooks): SSRF guard in all modes + verify signature before multipart (H3,H4)
- 2026-06-28 `ccb7243` fix(chat,forum): author self-delete in chat + remove dead forum edit code (M8,M9)
...
- 2026-07-08 `821aea9` docs(changelog): sync auto-appended entry
